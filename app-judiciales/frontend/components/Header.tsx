...
import { User, Menu, X, Home, Users, Settings, LogOut, Bell, ChevronDown, FileText, BarChart, Database, Shield, HelpCircle, BookOpen } from 'lucide-react'
...
export function Header({ userName = 'Admin User', userRole = 'Administrator' }: HeaderProps) {
  ...
  const menuItems: MenuItem[] = [
    ...
    { 
      ...
      href: '/users',
      submenu: [
        { icon: Shield, label: 'Gestión de Usuarios', href: '/users', description: 'Administrar usuarios del sistema' },
      ]
    },
    {
      icon: FileText,
      ...
      href: '/expedientes',
      subItems: [
        { icon: FileText, label: 'Gestión de Expedientes', href: '/expedientes', description: 'Administrar expedientes judiciales' },
      ]
    },
    // { 
    //   icon: Users,
    ...
    //   href: '/persons',
    //   submenu: [
    //     { icon: Users, label: 'Gestión de Personas', href: '/persons', description: 'Administrar personas' },
    //   ]
    // },
    // { 
    //   icon: BarChart, 
    ...
    //   href: '/analytics',
    //   submenu: [
    //     { icon: BarChart, label: 'Overview', href: '/analytics', description: 'General statistics' },
    //     { icon: FileText, label: 'Custom Reports', href: '/analytics/reports', description: 'Create custom reports' },
    //   ]
    // },
    // { 
    //   icon: Settings, 
    ...
    //   href: '/settings',
    //   submenu: [
    //     { icon: Settings, label: 'General', href: '/settings', description: 'General settings' },
    //     { icon: Shield, label: 'Security', href: '/settings/security', description: 'Security settings' },
    //     { icon: User, label: 'Profile', href: '/settings/profile', description: 'Your profile' },
    //   ]
    // },
    // { 
    //   icon: HelpCircle, 
    ...
    //   href: '/help',
    //   submenu: [
    //     { icon: BookOpen, label: 'Documentation', href: '/docs', description: 'Read the docs' },
    //     { icon: HelpCircle, label: 'Support', href: '/support', description: 'Get help' },
    //   ]
    // },
  ]
  ...
  // Color schemes for each submenu
                ...
                return (
                  <div key={item.label} className="relative group">
                    {hasSubmenu ? (
                      ...
                      <Link
                        href={item.href}
                        className={`group flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                          item.active
                            ? 'bg-blue-50 text-blue-700'
                            : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'
                        }`}
